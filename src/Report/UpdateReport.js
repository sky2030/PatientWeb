...
class UpdateReports extends React.Component {
    ...
    componentDidMount = () => {
        console.log(this.props.location.ReportItem.post.report_name)
        this.ReportItem();
    ...
    ReportItem = () => {
        this.setState({
            report_id: this.props.location.ReportItem.post.report_id,
            report_name: this.props.location.ReportItem.post.report_name,
    ...
    SubmitReport = (event) => {
        ...
        if (isValid) {
            ...
            url = `${url}/${this.props.location.ReportItem.post.report_id}`
