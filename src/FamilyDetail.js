...
class AddFamilyMember extends React.Component {
    ...
    FamilyDetail = () => {
        this.setState({
            id: this.props.location.Detail.post.id,
            name: this.props.location.Detail.post.name,
            relation: this.props.location.Detail.post.relation,
            birth_millis: this.props.location.Detail.post.birth_millis,
            height: this.props.location.Detail.post.height,
            weight: this.props.location.Detail.post.weight,
            gender: this.props.location.Detail.post.gender,
            age: this.props.location.Detail.post.age
            //     reportDate: moment(Number(this.props.location.ReportItem.post.report_date))
        });
    }
            ...
            <div className="Appcontainer">
                ...
                <div className="dashboard_wrap">
                    <div className="adddept">
                        ...
                        <h2>Family Member Detail</h2>

                        <form action="confirm" onSubmit={this.UpdateFamilyDetail}>
